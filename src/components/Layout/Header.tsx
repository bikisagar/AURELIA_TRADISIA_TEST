          ...
          <div className="hidden md:flex items-center space-x-8">
            {content.navigation.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`relative py-2 px-4 font-medium tracking-wide uppercase text-sm transition-colors duration-300 ${
          ...
          <div className="py-4 space-y-2 border-t border-luxury-gold/20 mt-4">
            {content.navigation.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`block py-3 px-4 font-medium tracking-wide uppercase text-sm transition-colors duration-300 ${
                  location.pathname === item.path
